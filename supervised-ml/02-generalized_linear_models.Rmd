...
This case study uses the data set from [this tutorial at UCLA](https://stats.oarc.ucla.edu/r/dae/multinomial-logistic-regression/).
...
A brief exploratory analysis helps set your expectations. 
