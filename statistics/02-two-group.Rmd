...
engage <- foreign::read.spss("./input/independent-samples-t-test.sav", 
                             to.data.frame = TRUE)
engage2 <- foreign::read.spss("./input/mann-whitney-test.sav",
                              to.data.frame = TRUE)
assertthat::are_equal(engage, engage2)
engage
engage2
engage_report <- list()
...
The Mann-Whitney U test is the nonparametric alternative to the independent-samples t-test for cases in which the samples are non-normally distributed or are ordinal rather than continuous.
