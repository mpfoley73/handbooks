...
Welch's ANOVA with the Games-Howell post-hoc test is a viable alternative to the established Fisher One-way ANOVA with the Tukey post-hoc test when the equality of variances assumption is violated. In the data set below, you can see how Step C appears to have a larger variance.
...
PMCMRplus::gamesHowellTest(newton_aov)
```
