...
Divide the covariance of two variables by the product of their standard deviations to get the _correlation_, $r_{jk} = \frac{s_{jk}}{s_j s_k}$. The sample corellation estimates the population correlation, $\rho_{jk} = \frac{\sigma_{jk}}{\sigma_j \sigma_k}$. Test the null hypothesis that $H_0: \rho_{jk} = 0$ with a *t*-test where
